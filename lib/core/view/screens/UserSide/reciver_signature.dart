...
class Reciversignaturescreen extends StatefulWidget {
  final Map<String, dynamic> order;
  const Reciversignaturescreen({super.key, required this.order});

  @override
  State<Reciversignaturescreen> createState() => _ReciversignaturescreenState();
}

class _ReciversignaturescreenState extends State<Reciversignaturescreen> {
  ...
  Future<void> _saveSignature() async {
    var orderid = widget.order["order_id"];
    if (controller.isNotEmpty) {
      ...
      if (signatureImage != null) {
        ...
        context.read<SignatureBloc>().add(ReciverSignatureCreatedEvent(
